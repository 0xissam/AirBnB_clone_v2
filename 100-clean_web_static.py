#!/usr/bin/python3
"""
script (based on the file 3-do_deploy_web_static.py) that deletes a
...
env.hosts = ['34.224.63.120', '54.90.28.250']
env.user = "ubuntu"


def deploy():
    """creates and distributes an archive for your web servers
    ...
    """
    # Call the do_pack() function and store path of the created archive
    archive_path = do_pack()
    if archive_path is None:
        print("Failed to create archive from web_static")
        return False

    # Call do_deploy function, using the new path off the new archive and
...
def do_clean(number=0):
    ...
    If number is 0 or 1, keep only most recent version of your archive.
