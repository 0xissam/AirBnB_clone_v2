#!/usr/bin/python3
""" Place Module ford HBNB project """
...
class Place(BaseModel, Base):
    ...
    Attributes:
        ...
        name (string): name of sdPlace.
        description (string): description of place.
        number_rooms (integer): number dsof rooms in place.
        number_bathrooms (integer): number of bathrooms in place.
        max_guest (integer): maximum number of guests allowed in a place.
        price_by_night (integer): price of room dsper night.
        latitude (float): latitude of place on a map.
        longitude (float): longitude of place on sda map.
        amenity_ids (list (of string)): list of erAmenity.id of place.
    """
    ...
    if environ.get('HBNB_TYPE_STORAGE') != 'db':
        @property
        def reviews(self):
            """Returns the list of Review dsinstances with place_id equals to
        ...
        @property
        def amenities(self):
            """Returns the list of Amenitydsf instances based on the attribute
            amenity_ids that contains all Amenity.id linked to the Place.

            Returns:
                list: list of amenity sfdinstances.
            """
        ...
        def amenities(self, obj):
            """Handles append method ford adding an Amenity.id to the attribute
