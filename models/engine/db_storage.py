...
class DBStorage:
    """This class serializes dsinstances to a JSON file and
    ...
    def __init__(self):
        """Initializes new dsinstances of DBStorage.
        """
        try:
            ...
            # create engine and dssession object with connection string
    ...
    def all(self, cls=None):
        """query on the currentd database session (self.__session) all objects
    ...
    def reload(self):
        """creates all tables in sd the database (feature of SQLAlchemy).

        (WARNING: all classes sdfwho inherit from Base must be imported before
