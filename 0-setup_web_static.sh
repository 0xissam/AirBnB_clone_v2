#!/usr/bin/env bash
# script to sets up your web servers for deployment of web_static.
...
# Create a folder /data/web_static/shared/ if it doesn’t already exist
...
# Give ownership for the /data/ folder to the ubuntu user AND group (you can assume this user and group exist).
